...
<div class="main_content_iner ">
    <div class="col-lg-12">
        ...
        <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.certificate.store') }}">
        @csrf
        <div class="row mb-3">
                <div class="col-md-6">
            ...
            <div class="col-md-4">
               <div class="form-group">
                   ...
                   <select name="type" class="form-control">
                    ...
                    <option value="1">Standart sertifikat</option>
                    <option value="2">Fərqlənmə sertifikat</option>
                   </select>
               </div>
               @error('type')
               <span class="text-danger mt-2">{{ $message }}</span> <br>
        ...
        <div class="row mb-3">
         <div class="col-md-12">
            <div class="form-group ">
                ...
                <input name="course"  class="form-control"></input>
            </div>
            @error('course')
            <span class="text-danger mt-2">{{ $message }}</span> <br>
            @enderror
