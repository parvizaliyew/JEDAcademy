                            ...
                            <div class="QA_section">
                                <div class="white_box_tittle list_header">
                                    ...
                                    <div class="add_button ms-2">
                                        <a href="{{ route('admin.news-event.create') }}" class="btn_1">Əlavə et</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex" style="font-size: 20px;">
                                                <a class="btn btn-primary" href="{{ route('admin.news-event.edit',$item->id) }}"><i class="ti-pencil"></i></a>
                                                <a class="btn btn-danger delete" href="{{ route('admin.news-event.delete',$item->id) }}"><i class="ti-trash"></i></a>                                               
                                            </td>
