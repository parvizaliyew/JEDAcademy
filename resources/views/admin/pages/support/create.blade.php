...
<div class="main_content_iner ">
    <div class="col-lg-12">
        ...
        <h3 class="m-0">Karyera dəstəyi </h3>
        </div>
        ...
        <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.support.store') }}">
        @csrf
        <div class="row mb-3">
         <div class="col-md-12">
        ...
        <a href="{{ route('admin.support.index') }}" class="btn btn-success">Geri</a>
